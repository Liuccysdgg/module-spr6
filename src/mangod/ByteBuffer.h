...
class ByteBuffer
{
    public:
        ...
        ByteBuffer& operator<<(ushort value)
        {
            append<ushort>(value);
            return *this;
        }
        ...
        void append(std::vector<unsigned char> const& src)
        {
        ...
        {
            return append((unsigned char const*)src, cnt);
        }

        template<class T> void append(T const* src, size_t cnt)
        {
            return append((unsigned char const*)src, cnt * sizeof(T));
        }

        void append(unsigned char const* src, size_t cnt)
        {
            if (!cnt)
                return;
