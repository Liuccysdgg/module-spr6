...
class SRP6
{
    public:
        ...
        */
        ...
        BNumber GetHostPublicEphemeral(void) { return B; };
        BNumber GetGeneratorModulo(void) { return g; };
        BNumber GetPrime(void) { return N; };
        BNumber GetProof(void) { return M; };
        BNumber GetSalt(void) { return s; };
        BNumber GetStrongSessionKey(void) { return K; };
        BNumber GetVerifier(void) { return v; };
